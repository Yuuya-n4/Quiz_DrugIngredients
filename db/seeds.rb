...
quiz1 = Quiz.create!(quiz_set_id: quiz_set1.id, question: 'サンプルクイズ1', explanation: '解説1', drug_type: 1)
quiz2 = Quiz.create!(quiz_set_id: quiz_set1.id, question: 'サンプルクイズ2', explanation: '解説2', drug_type: 1)
quiz3 = Quiz.create!(quiz_set_id: quiz_set1.id, question: 'サンプルクイズ3', explanation: '解説3', drug_type: 1)
